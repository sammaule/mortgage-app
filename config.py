...
stamp_duty_rates = [
    {
        ...
        "normal_rate": [0., 0.05, 0.1, 0.12],
        "first_time_rate": [0., 0.05, 0.1, 0.12],
    ...
    },
    {
        ...
        "normal_rate": [0., 0.05, 0.05, 0.1, 0.12],
    ...
    },
    {
        ...
        "normal_rate": [0., 0.02, 0.05, 0.05, 0.1, 0.12],
        "first_time_rate": [0., 0., 0., 0.05, 0.1, 0.12],
